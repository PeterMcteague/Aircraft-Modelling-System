...
/**A decoration for an aircraft that adds a kids area to it.
 * 
 * @author 07mct
 * @see AircraftDecorator
 * @see Aircraft
 */
public class AircraftKidsDecoration extends AircraftDecorator
{   
     ...
     */
    public AircraftKidsDecoration(Aircraft ac) 
    {
        super(ac);
    }
     ...
     * In this case it adds a kids area to the aircraft it is decorating.
     * 
    ...
    {
        //super.createAircraft();
        return (super.createAircraft() + " It also has a kids area.");
    }
}
